...
ru_qoptions = (
    ...
    {'option': "order",
     ...
     'desc': u"Сортировать результаты в заданном порядке. Каждый аргумент можно использовать с суффиксом <b>.d</b>, это будет означать сортировку в обратном порядке." + ru_multiarg + u" Aргументы означают следующее: " + ru_order_desc(),
    },
)
