...
ru_qoptions = (
    ...
    {'option': "scale",
     'args': "<i>integer</i>",
     'desc': u"Расширить диапазон первичного поиска по имени файла/пути. Наличие этой опции в запросе приведёт к значительному увеличению времени поиска. Вместо того, чтобы подкручивать scale, лучше указать больше информации об имени файла/пути.",
    },
)
